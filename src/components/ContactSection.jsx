        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            <div className="space-y-6 justify-center">
              ...
              <hr className="h-px my-8 bg-primary border-0 dark:bg-primary"></hr>
              <div className="flex space-x-7 px-1">
                ...
                <div className="tooltip">
                  <span className="tooltiptext">Strava</span>
                  <a href="https://www.strava.com/athletes/106845045" target="_blank">
                    <svg 
                      height="38"
                      width="38"                      
                      version="1.1" 
