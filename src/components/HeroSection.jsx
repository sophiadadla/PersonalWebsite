export const HeroSection = () => {
  return (
    <section
      id="hero"
      className="relative min-h-screen flex flex-col md:flex-row items-center justify-center pt-24 md:pt-0 px-4 overflow-hidden"
    >
      <div className="flex flex-col md:flex-row items-center md:items-center md:space-x-8 text-center md:text-left">
        ...
        <div className="md:order-1 md:mr-10 mt-8 md:mt-0">
          <img src="IMG_6726.png" className="headshot-style w-40 md:w-52" alt="Sophia's headshot"></img>
        </div>
      </div>
    </section>
  );
